...
<body>
    <header class="container-fluid lindavista">
        <div class="d-flex container align-items-center title">
            <div class="mr-5">
                <img src="img/img1.jpg" class="border  icon" alt="">
            </div>
            <div class="title-linda">
                <h1>Lindavista</h1>
                <h5>Construimos un mundo mejor para usted</h5>
            </div>
        </div>
    </header>
    <main class="container-fluid row mt-3">
        ...
        <section class="col-8 notice-content">
            <p class="notice-title">Noticias</p>
            <div class="row align-items-center notice-area py-2 justify-content-center">
                <div class="col-7">
                    <div class="">
                        <p class="desc-title"> Nueva promoción en la costa</p>
                        <p class="description">
                ...
                <img src="img/img1.jpg" class="col-3 notice" alt="">
            </div>
            <div class="row align-items-center notice-area mt-3 py-2 justify-content-center">
                <div class="col-7">
                    <div class="">
                        <p class="desc-title"> Finalizando la promoción "Nueva Atalaya"</p>
                        <p class="description">
        ...
        <section class="col-2 d-flex flex-column align-items-center">
            <img src="img/img1.jpg" class=" photo mb-2" alt="">
            <img src="img/img1.jpg" class=" photo mb-2" alt="">
            <img src="img/img1.jpg" class=" photo mb-2" alt="">
            <img src="img/img1.jpg" class=" photo mb-2" alt="">
        </section>
    ...
    <footer>
        <div class="text-center mt-3 bg-primary p-2" style="font-style: italic; color: #fff;">
